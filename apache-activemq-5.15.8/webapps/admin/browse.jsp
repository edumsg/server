                ...
                <c:if test="${queueNameSubStr eq 'DLQ.' || queueNameSubStr eq 'DLT.'}">
                    ...
                    <a href="<c:url value="moveMessage.action">
                     ...
                     <c:param name="secret" value='${sessionScope["secret"]}' />
                       ...
                       onclick="return confirm('Are you sure you want to retry this message on queue://<c:out
                               value="${moveToQueue}"/>?')"
...
<div>
    <a href="queueConsumers.jsp?JMSDestination=<c:out value="${requestContext.queueBrowser.JMSDestination}"/>">View
        Consumers</a>
</div>
